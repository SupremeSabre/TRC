...
<div class="container">
				...
				<div class="log_box">
					...
					<div class="gray_box">
						<div class="box">
							...
							<strong>安装选择</strong>
							<label><input class="radio" type="radio" name='install_type' value='all' />带测试数据版本【<a href="http://www.google.com/notice/107-iwebshop" target="_blank" style="color:red">必须提前手动下载商品图片包108MB</a>】</label><br />
	...
	<div class="foot"><a href="http://www.google.com">关于我们</a>|<a href="http://www.google.com">官方网站</a>|<a href="http://www.google.com">联系我们</a>|<a href="">©2005-2017</a></div>
</div>
